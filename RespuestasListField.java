...
public class RespuestasListField extends ListField implements ListFieldCallback {
	...
	private Vector rows;
	 ...
	 public void drawListRow(ListField listField, Graphics g, int index, int y,
	   int width) {
		 RespuestasListField list = (RespuestasListField) listField;
